			  ...
			  <div class="panel-body">
				<form role="form" id="userForm">
				  <div class="form-group">
					...
					<input type="text" class="form-control" name="addAccount" id="addAccount" value="${user.account }" placeholder="请输入登陆账号">
				  </div>
				  <div class="form-group">
					<label for="exampleInputPassword1">用户名称</label>
					<input type="text" class="form-control" name="addName" id="addName" value="${user.name }" placeholder="请输入用户名称">
				  </div>
				  <div class="form-group">
					<label for="exampleInputEmail1">邮箱地址</label>
					<input type="email" class="form-control" name="addEmail" value="${user.email }" id="addEmail" placeholder="请输入邮箱地址">
        ...
        <script type="text/javascript">
            $(function () {
			    ...
			    $("#updateBtn").click(function(){
			    	...
			    	if(addAccount == ""){
			    		layer.msg("账号名不能为空", {time:1000, icon:5, shift:6}, function(){});
			        	return;
			    	}
			    	if(addName == ""){
