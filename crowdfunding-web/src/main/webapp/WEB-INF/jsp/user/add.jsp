			  ...
			  <div class="panel-body">
				<form role="form">
				  <div class="form-group">
					...
					<input type="text" class="form-control" name="addAccount" id="addAccount" placeholder="请输入登陆账号">
				  </div>
				  <div class="form-group">
					<label for="exampleInputPassword1">用户名称</label>
					<input type="text" class="form-control" name="addName" id="addName" placeholder="请输入用户名称">
				  </div>
				  <div class="form-group">
					<label for="exampleInputEmail1">邮箱地址</label>
					<input type="email" class="form-control" name="addEmail" id="addEmail" placeholder="请输入邮箱地址">
			    	...
			    	$.ajax({
			        	...
			        	success : function(result){
			        		...
			        		if(result.success){
			        			...
			        			layer.msg("新增失败", {time:1000, icon:5, shift:6}, function(){});
			        		}
